...
@section('content')
    ...
    <form method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="name" id="name" value="{{ old('name', $game->name) }}" class="rounded-lg">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="image" id="image" value="{{ old('image', $game->image) }}" class="rounded-lg">
        </div>
        ...
        <button class="inline-block bg-gray-800 text-gray-300 px-4 py-2 rounded-lg hover:bg-gray-600 hover:scale-105 duration-200">Modifir {{ $game->name }}</button>
    </form>
@endsection
