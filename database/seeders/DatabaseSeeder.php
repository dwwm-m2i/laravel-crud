...
class DatabaseSeeder extends Seeder
{
    ...
    {
        $ps5 = Platform::factory()->create(['name' => 'PlayStation 5']);
        $xbox = Platform::factory()->create(['name' => 'Xbox Serie X']);
        $pc = Platform::factory()->create(['name' => 'PC']);

        // Game::factory(4)->create();

        $er = Game::factory()->create([
            'name' => 'Elden Ring',
        ...
        $er->platforms()->attach([$ps5->id, $xbox->id, $pc->id]);

        $wow = Game::factory()->create([
        ...
        $wow->platforms()->attach($pc);

        $cp = Game::factory()->create([
        ...
        $cp->platforms()->attach([$ps5->id, $xbox->id, $pc->id]);

        $w3 = Game::factory()->create([
            'name' => 'The Witcher 3',
        ...
        $w3->platforms()->attach([$ps5->id, $xbox->id, $pc->id]);

        $sp = Game::factory()->create([
        ...
        $sp->platforms()->attach($ps5);

        $rdr = Game::factory()->create([
        ...
        $rdr->platforms()->attach([$ps5->id, $xbox->id, $pc->id]);
    }
}
